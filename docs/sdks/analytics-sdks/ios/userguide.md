...
For more detailed information, please refer to the [Advanced Usage](../../category/advanced-usage-1).
...
* Version settings: 10.5.0 "Up to Next Major"
...
To find data for a certain event type, such as one of the [standard events](./ios-user-guide#standard-events), you can add the `etype` to your search query, for example `aid:999 AND etype:_rem_launch`.
...
![appstore-idfa.png](img/appstore-idfa.png)*IDFA usage disclosure*
